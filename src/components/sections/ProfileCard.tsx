            ...
            <div className="grid grid-cols-3 gap-2" style={{ direction: 'ltr' }}>
              {TECH_GRID.map((tech, i) => (
                <motion.div
                  ...
                  className="inline-flex items-center gap-1 sm:gap-2 px-2 py-1.5 sm:px-3 sm:py-2.5 rounded-xl cursor-default transition-all duration-200"
                  style={{
                ...
                >
                  <tech.Icon className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0" style={{ color: tech.color }} />
                  <span className="text-[10px] sm:text-xs font-semibold whitespace-nowrap" style={{ color: tech.color }}>
                    {tech.name}
                  </span>
                </motion.div>
              ))}
